...
{
    /// <summary>
    /// Returns the hunks as a lazy sequence so the caller can render them
    /// progressively as the diff is computed. Binary and oversized files are
    /// flagged up front; syntax highlighting is resolved before the first hunk and
    /// attached as hunks stream.
    /// </summary>
